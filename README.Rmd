...
* I wish I could conduct unit root using EViews routines in R Markdown or Quarto document
...
uroot(dataFrame,format = "markdown", caption = "All test")
```
...
adf(dataFrame,format = "markdown",caption = "ADF test")
```
...
pp(dataFrame,format = "markdown",caption = "PP test")
```
